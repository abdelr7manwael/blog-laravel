...
@endif
<form class="mt-4" method="post" action="{{url('posts/store')}}" enctype="multipart/form-data">
    @csrf
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <input type="text" name="desc" class="form-control" value="{{old('desc')}}" id="exampleInputEmail1" aria-describedby="emailHelp">
      ...
      <div class="mb-3">
        ...
        <textarea type="text" name="content" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">{{old('content')}}</textarea>
      </div>
